 ...
 * Section: LBL A2
 * Partner: Hanwen Yang (we shared the same code which we finished together)
 * Project: Lighting
 */
...
*  RESET <—> Arduino Pin 8
*  D/C <—> Arduino Pin 7
*  CARD_CS <—> Arduino Pin 5
*  TFT_CS <—> Arduino Pin 6
*  MOSI <—> Digital 51
*  SCK <—> Digital 52
*  MISO <—> Digital 50
...
3.
The feature of the game (very very important)
*  At first(start face), there are two options(use JoyStick to choose)
*  You should press the JoyStick to enter the face 
*  if you choose “SCORE” it will turn to score_face which store your the most three highest score after you playing the game 
*  if you choose “PLAY” it will turn to game_face. (initial life : 2)
   ...
   3) when your score get 40*i(i is positive integer) it will appear yellow block (and if you can shoot it,       
   your will get one more life ( the life you have is showed under the Screen).
...
*  When your life is “0” ,it will change to fail_face and after a little time it will shows rating_face And you can use the potentiometer to rate this game (least 1 most 3) under the Rating you can see the average rating score.
